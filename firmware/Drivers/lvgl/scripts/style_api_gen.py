...
props = [
    ...
    {'name': 'WIDTH',
     'style_type': 'num', 'var_type': 'int32_t', 'default': 'Widget dependent', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
    ...
    {'name': 'ALIGN',
     'style_type': 'num', 'var_type': 'lv_align_t', 'default': '`LV_ALIGN_DEFAULT`', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
    ...
    {'section': 'Padding',
     'dsc': "Properties to describe spacing between the parent's sides and the children and among the children. Very similar to the padding properties in HTML."},
    {'name': 'PAD_TOP',
     'style_type': 'num', 'var_type': 'int32_t', 'default': 0, 'inherited': 0, 'layout': 1, 'ext_draw': 0,
    ...
    {'section': 'Margin',
     'dsc': "Properties to describe spacing around a Widget. Very similar to the margin properties in HTML."},
    {'name': 'MARGIN_TOP',
     'style_type': 'num', 'var_type': 'int32_t', 'default': 0, 'inherited': 0, 'layout': 1, 'ext_draw': 0,
    ...
    {'name': 'BG_COLOR',
     'style_type': 'color', 'var_type': 'lv_color_t', 'default': '`0xffffff`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0, 'filtered': 1,
     'dsc': "Set background color of Widget."},

    {'name': 'BG_OPA',
     'style_type': 'num', 'var_type': 'lv_opa_t', 'default': '`LV_OPA_TRANSP`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'BG_GRAD_COLOR',
     'style_type': 'color', 'var_type': 'lv_color_t', 'default': '`0x000000`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0, 'filtered': 1,
     'dsc': "Set gradient color of the background. Used only if `grad_dir` is not `LV_GRAD_DIR_NONE`"},

    {'name': 'BG_GRAD_DIR',
     'style_type': 'num', 'var_type': 'lv_grad_dir_t', 'default': '`LV_GRAD_DIR_NONE`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'BG_GRAD',
     'style_type': 'ptr', 'var_type': 'const lv_grad_dsc_t *', 'default': '`NULL`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'BG_IMAGE_OPA',
     'style_type': 'num', 'var_type': 'lv_opa_t', 'default': '`LV_OPA_COVER`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'BORDER_SIDE',
     'style_type': 'num', 'var_type': 'lv_border_side_t', 'default': '`LV_BORDER_SIDE_NONE`', 'inherited': 0,
     'layout': 0, 'ext_draw': 0,
    ...
    {'section': 'Outline',
     'dsc': 'Properties to describe the outline. It\'s like a border but drawn outside of the rectangles.'},
    {'name': 'OUTLINE_WIDTH',
     'style_type': 'num', 'var_type': 'int32_t', 'default': 0, 'inherited': 0, 'layout': 0, 'ext_draw': 1,
    ...
    {'name': 'TEXT_COLOR',
     'style_type': 'color', 'var_type': 'lv_color_t', 'default': '`0x000000`', 'inherited': 1, 'layout': 0,
     'ext_draw': 0, 'filtered': 1,
     'dsc': "Sets color of text."},

    {'name': 'TEXT_OPA',
     'style_type': 'num', 'var_type': 'lv_opa_t', 'default': '`LV_OPA_COVER`', 'inherited': 1, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'TEXT_FONT',
     'style_type': 'ptr', 'var_type': 'const lv_font_t *', 'default': '`LV_FONT_DEFAULT`', 'inherited': 1, 'layout': 1,
     'ext_draw': 0,
    ...
    {'name': 'TEXT_DECOR',
     'style_type': 'num', 'var_type': 'lv_text_decor_t', 'default': '`LV_TEXT_DECOR_NONE`', 'inherited': 1, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'TEXT_ALIGN',
     'style_type': 'num', 'var_type': 'lv_text_align_t', 'default': '`LV_TEXT_ALIGN_AUTO`', 'inherited': 1, 'layout': 1,
     'ext_draw': 0,
    ...
    {'name': 'COLOR_FILTER_DSC',
     'style_type': 'ptr', 'var_type': 'const lv_color_filter_dsc_t *', 'default': '`NULL`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'ANIM',
     'style_type': 'ptr', 'var_type': 'const lv_anim_t *', 'default': '`NULL`', 'inherited': 0, 'layout': 0,
     'ext_draw': 0,
    ...
    {'name': 'TRANSITION',
     'style_type': 'ptr', 'var_type': 'const lv_style_transition_dsc_t *', 'default': '`NULL`', 'inherited': 0,
     'layout': 0, 'ext_draw': 0,
     'dsc': "An initialized ``lv_style_transition_dsc_t`` to describe a transition."},

    {'name': 'BLEND_MODE',
     'style_type': 'num', 'var_type': 'lv_blend_mode_t', 'default': '`LV_BLEND_MODE_NORMAL`', 'inherited': 0,
     'layout': 0, 'ext_draw': 0,
    ...
    {'name': 'BASE_DIR',
     'style_type': 'num', 'var_type': 'lv_base_dir_t', 'default': '`LV_BASE_DIR_AUTO`', 'inherited': 1, 'layout': 1,
     'ext_draw': 0,
    ...
    {'name': 'FLEX_FLOW',
     'style_type': 'num', 'var_type': 'lv_flex_flow_t', 'default': '`LV_FLEX_FLOW_NONE`', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
     'dsc': "Defines in which direct the flex layout should arrange the children"},

    {'name': 'FLEX_MAIN_PLACE',
     'style_type': 'num', 'var_type': 'lv_flex_align_t', 'default': '`LV_FLEX_ALIGN_NONE`', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
    ...
    {'name': 'FLEX_GROW',
     'style_type': 'num', 'var_type': 'uint8_t', 'default': '`LV_FLEX_ALIGN_ROW`', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
    ...
    {'name': 'GRID_COLUMN_DSC_ARRAY',
     'style_type': 'ptr', 'var_type': 'const int32_t *', 'default': '`NULL`', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
     'dsc': "An array to describe the columns of the grid. Should be LV_GRID_TEMPLATE_LAST terminated"},

    {'name': 'GRID_COLUMN_ALIGN',
     'style_type': 'num', 'var_type': 'lv_grid_align_t', 'default': '`LV_GRID_ALIGN_START`', 'inherited': 0,
     'layout': 1, 'ext_draw': 0,
    ...
    {'name': 'GRID_CELL_COLUMN_POS',
     'style_type': 'num', 'var_type': 'int32_t', 'default': '`LV_GRID_ALIGN_START`', 'inherited': 0, 'layout': 1,
     'ext_draw': 0,
